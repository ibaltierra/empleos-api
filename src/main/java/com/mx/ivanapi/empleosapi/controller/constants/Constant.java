package com.mx.ivanapi.empleosapi.controller.constants;
...
public class Constant {
	...
	public final static String BASE_PACKAGE_CATEGORIA ="/apiCategoria";
	public final static String BASE_PACKAGE_SOLICITUDES ="/apiSolicitudes";
